...
(function () {
  ...
  // Маска телефона: шаблон «### ###-##-##» (# — слот цифры). Введённые цифры идут в
  // «typed» (видны в input поверх), незаполненные позиции — в «rest» (прозрачно-серые).
  // Разделитель уходит в rest, если после него уже нет введённых цифр (без «хвостов»).
  var PHONE_TPL = "### ###-##-##";
