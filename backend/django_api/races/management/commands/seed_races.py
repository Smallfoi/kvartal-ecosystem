...
RACES = [
    ...
    # ── Республика Саха (Якутия) — регион по умолчанию у клиентов Квартала ──
    ("ЗаБег.РФ — Якутск", dt.date(2026, 5, 17), "Якутск", "Республика Саха (Якутия)", "Площадь Ленина",
     REG, "road", ["21.1 км", "10 км", "5 км", "1 км"], Race.REG_DONE, 150, "https://забег.рф/",
     "Якутский этап всероссийского полумарафона «ЗаБег.РФ» — единый день бега по всей стране."),
    ("Ночной забег в Якутске", dt.date(2026, 8, 29), "Якутск", "Республика Саха (Якутия)", "Набережная Лены",
     REG, "night", ["10 км", "5 км"], Race.REG_OPEN, 90, "",
     "Вечерний старт по набережной — атмосферный городской забег в столице Якутии."),
    ("Кросс нации — Якутск", dt.date(2026, 9, 19), "Якутск", "Республика Саха (Якутия)", "Стадион «Туймаада»",
     REG, "road", ["5 км", "3 км", "1 км · дети"], Race.REG_SOON, 60, "",
     "Якутский этап всероссийского дня бега «Кросс нации» — массовый забег для всех возрастов."),
]
