...
- Технический package id оставлен `com.kvartal.kvartal_app`, чтобы APK обновлялся поверх установленного приложения.
  **Устарело (2026-08-18):** идентификатор сменён на `ru.mata.kvartal` перед публикацией (D-34) — новый APK ставится как отдельное приложение, старое нужно удалить вручную.
